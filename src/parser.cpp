...
#line 140 "parser.cpp" /* yacc.c:358  */
...
{
       0,    21,    21,    22,    23,    26,    27,    28,    42,    54,
      55,    63,    69,    75,    81,    82,    90,   110,   148,   149,
     154
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'-'", "'+'", "'*'", "'^'", "'('", "')'", "'='", "$accept", "file",
  "optionline", "poly_def", "monowithsign", "mono", "varstr", "exp", YY_NULLPTR
};
#endif
...
{
     -14,    13,   -14,   -12,    26,   -14,   -14,    -1,   -14,   -14,
     -14,   -14,     3,     4,    -1,   -14,    -5,   -14,    25,    -1,
      -5,    14,     4,    15,     4,     4,    16,   -14,    17,   -14,
      -5,    -5,   -14
};
...
{
       2,     0,     1,     0,     0,     4,     3,     0,     7,     5,
       6,    13,    11,     0,     0,    18,     9,    15,     8,     0,
      10,     0,     0,     0,     0,     0,     0,    16,    14,    12,
      20,    19,    17
};
...
{
      20,     7,    11,    12,    22,    23,    13,    11,    12,    28,
      14,    30,    31,     2,    19,    14,     0,     3,    29,     4,
      21,    24,    25,    24,    25,    26,    27,    23,    32,     8,
       9,    10,    24,    25
};

static const yytype_int8 yycheck[] =
{
      13,    13,     3,     4,     9,    10,     7,     3,     4,    22,
      11,    24,    25,     0,    11,    11,    -1,     4,     3,     6,
      14,     7,     8,     7,     8,    19,    12,    10,    12,     3,
       4,     5,     7,     8
};
...
static const yytype_uint8 yystos[] =
{
       ...
       5,     3,     4,     7,    11,    18,    19,    20,    21,    11,
      19,    21,     9,    10,     7,     8,    21,    12,    19,     3,
      19,    19,    12
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 21 "parser.ypp" /* yacc.c:1646  */
    {}
...
#line 1247 "parser.cpp" /* yacc.c:1646  */
  ...
  case 6:
#line 27 "parser.ypp" /* yacc.c:1646  */
    { parse_options(get<string>((yyvsp[-1])), get<string>((yyvsp[0]))); }
...
#line 29 "parser.ypp" /* yacc.c:1646  */
    {
	if (get<string>((yyvsp[-1]))=="tmp_start")
		tmp_start = get<int64_t>((yyvsp[0]));
    else if (get<string>((yyvsp[-1]))=="max_terms")
        max_terms = get<int64_t>((yyvsp[0]));
	else
	{
		std::cerr<<"ERROR:Unknown option:"<<(yyvsp[-1])<<std::endl;
		exit(1);
	}
}
...
#line 43 "parser.ypp" /* yacc.c:1646  */
    {
	auto& P = get<polynomial>((yyvsp[0]));
	P.name() = get<string>((yyvsp[-2]));
	vP.push_back(P);
...
#line 91 "parser.ypp" /* yacc.c:1646  */
    {
	int nli = vP_get(get<polynomial>((yyvsp[-1])));
	if (nli == -1)
	{
		nli = get<polynomial>((yyvsp[-1])).single_id();
		if (nli == -1)//new polynomial
		{
			nli = literal_append_tmp();
			get<polynomial>((yyvsp[-1])).name() = literal_name(nli);
			literal_set_ring_level(nli, get<polynomial>((yyvsp[-1])).ring_level());
			vP.push_back(std::move(get<polynomial>((yyvsp[-1]))));
		}
	}
	else 
	{
...
#line 148 "parser.ypp" /* yacc.c:1646  */
    { (yyval) = polynomial(get<monomial>((yyvsp[0]))); }
...
#line 150 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval) = std::move(get<polynomial>((yyvsp[-2])));
	get<polynomial>((yyval)) += std::move(get<monomial>((yyvsp[0])));
}
