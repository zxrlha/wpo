...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "IDENTIFY",
  "STRING", "OPTION", "'-'", "'+'", "'*'", "'^'", "'('", "')'", "'='",
  "$accept", "file", "optionline", "poly_def", "monowithsign", "mono",
  "varstr", "exp", YY_NULLPTR
};
